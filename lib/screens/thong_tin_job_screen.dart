...
class _ThongTinJobScreenState extends State<ThongTinJobScreen> {
  ...
  //                                 .firstWhere((contract) =>
  //                                     contract.contractId == rate.contractId)
  //                                 .hostName;
  //                           }
  //                           var index = getJobByType2.rateList.indexOf(rate);
  //                           DateTime date = DateTime.parse(
  //                                   getJobByType2.contractList[index].createdAt)
  //                               .toLocal();
  //                           return nameHost != ''
  //                               ? Card(
  //                                   color: Colors.white,
              ...
              children: [
                ...
                widget.jobInfo[0].host.id == loginController.hostId
                    ? widget.jobInfo[0].status.toString() == 'accept'
                        ...
                        : Column(children: [
                            ...widget.jobInfo[0].contracts.map((contract) {
                              return widget.jobInfo[0].status.toString() ==
                                      'cancel'
                                  ? const SizedBox()
                                  : GestureDetector(
                                      onTap: () async {
                            ...
                            child: OutlinedButton(
                              onPressed: () async {
                                await hostDone.hostDone(
                                  contractId:
                                      widget.jobInfo[0].contract.contractId,
                                  jobId: widget.jobInfo[0].contract.jobId,
                                  hostId: widget.jobInfo[0].contract.hostId,
                                  hostName: widget.jobInfo[0].contract.hostName,
                                );
                                Get.to(
                                  HostRateScreen(
                                    workerName: widget.jobInfo[0].employee.name,
                                    profileImage:
                                        widget.jobInfo[0].employee.profileImage,
                                    contractId: widget
                                        .jobInfo[0].contracts[0].contractId,
                                    jobId: widget.jobInfo[0].contracts[0].jobId,
                                    employeeId: widget
                                        .jobInfo[0].contracts[0].employeeId,
                                    hostId:
                                        widget.jobInfo[0].contracts[0].hostId,
                                  ),
                                );
                              },
                              ...
                              onPressed: () async {
                                await workerdone.workerDone(
                                  ...
                                  employeeId:
                                      widget.jobInfo[0].contract.employeeId,
                                  employeeName:
                                      widget.jobInfo[0].contract.employeeName,
                                );
                                Get.to(WorkerRateScreen(
                                  ...
                                  contractId:
                                      widget.jobInfo[0].contracts[0].contractId,
                                  employeeId:
                                      widget.jobInfo[0].contracts[0].employeeId,
                                  hostId: widget.jobInfo[0].contracts[0].hostId,
                                  jobId: widget.jobInfo[0].contracts[0].jobId,
                                ));
                              },
                              style: OutlinedButton.styleFrom(
