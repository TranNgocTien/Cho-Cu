...
import 'package:chotot/controllers/active_user.dart';
...
class DeactiveUserTabOTP extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    ActiveUser activeUser = Get.put(ActiveUser());
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: TextFormField(
                    controller: activeUser.password,
