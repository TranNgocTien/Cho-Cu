            ...
            children: [
              ...
              Center(
                child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...statisticsData[0].workerTypeList.map((workerType) {
                          JobTypeModel typeName = jobTypeList.firstWhere(
                              (type) => type.jobtypeId == workerType.name);
                          return Card(
                            color: Colors.white,
                            elevation: 1,
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CircularPercentIndicator(
                                    radius: 50,
                                    percent: int.parse(workerType.amount) /
                                        int.parse(statisticsData[0].workers),
                                    animation: true,
                                    lineWidth: 10,
                                    ...
                                    progressColor: Colors.primaries[Random()
